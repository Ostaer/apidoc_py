define([
  ...
  var initDynamic = function() {
      ...
      $(".sample-request-send").on("click", function(e) {
          ...
          var project_name = $("#sample-request-param-field-project_name").val()
          initWSConnect(project_name);
          sendSampleRequest(group, name, version, $(this).data("sample-request-type"));
          stopWSLog(project_name);
      });

      // product_name change
       $("#sample-request-param-field-project_name").change(function(){
            var product_name = $("#sample-request-param-field-project_name").val();
            $("#process_output").attr("product_name", product_name);
            //console.log("change: "+ $("#process_output").attr("product_name"));
        });
    ...
    function initWSConnect(project_name) {
        //发送消息
        socket.emit('ask_for_logger', {'project_name': project_name});
    };

    function stopWSLog(project_name)
    {
        socket.emit('stop_for_log', {'project_name': project_name});
    }
  function sendSampleRequest(group, name, version, type)
  {
      ...
      $root.find(".sample-request-response-json").html("Loadinggg...");
      $("#process_output .process_output_json").html("");
      refreshScrollSpy();
  ...
  function clearSampleRequest(group, name, version)
  {
      ...
      $root.find(".process_output_json").html("");
      $root.find(".sample-request-response").hide();
      $root.find(".process_output_json").hide();
